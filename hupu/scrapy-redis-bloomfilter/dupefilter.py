...
from .utils import ignore_params
...
class RFPDupeFilter(BaseDupeFilter):
    ...
    def from_settings(cls, settings):
        ...
        return cls(server, key=key, debug=debug, bit=bit,
    ...
    def request_fingerprint(self, request):
        ...
        str
        """
        request_duplicate = request
        request_duplicate = ignore_params(request_duplicate)
        return request_fingerprint(request_duplicate)
